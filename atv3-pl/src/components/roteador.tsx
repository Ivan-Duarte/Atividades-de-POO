...
const Roteador: React.FC<RoteadorProps> = () => {
    const clienteProps = {
        tema: 'seuTema',
        nome: 'Nome do Cliente',
        nomeSocial: 'Nome Social do Cliente',
        cpf: '123.456.789-00',
        rg: '1234567',
        dataCpf: '01/01/2023',
        dataRg: '02/01/2023',
  ...
  const [tela, setTela] = useState<string>("Cadastrar");
  const [exibirDropdown, setExibirDropdown] = useState<boolean>(false);

  const selecionarView = (valor: string, e: MouseEvent) => {
    e.preventDefault();
    if (valor === "Cadastrar") {
